...
- **Change monitoring** — after you've shared, new/moved/cancelled meetings raise a "your schedule changed since you shared it" notification with one-tap re-share — and, if you opt in (Settings → Schedule changes), for today a full-screen ringing alert saying what changed, with Sync & Re-share, Open itinerary, Silence and Dismiss
