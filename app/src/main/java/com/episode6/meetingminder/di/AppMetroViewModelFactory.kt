...
/**
 * Builds every ViewModel contributed with `@ViewModelKey` + `@ContributesIntoMap(AppScope::class)`
 * (or an assisted factory); provided to Compose as `LocalMetroViewModelFactory` in
 * `MainActivity`.
 */
@Inject
